import { r as reactExports, j as jsxRuntimeExports, o, a as reactDomExports, v as vt, u as useNavigate } from "./index-BKHIuhAu.js";
import { M as MotionConfigContext, i as isHTMLElement$1, d as useConstant, P as PresenceContext, e as usePresence, f as useIsomorphicLayoutEffect$1, L as LayoutGroupContext, c as createLucideIcon, u as useAuth, a as useProfile, b as useLinks, g as useSetProfile, h as useAddLink, j as useUpdateLink, k as useDeleteLink, m as motion, E as ExternalBlob } from "./createLucideIcon-C5S-XaM5.js";
...
function Accessibility(_ref) {
  ...
  const markup = o.createElement(o.Fragment, null, o.createElement(HiddenText, {
    id: hiddenTextDescribedById,
    value: screenReaderInstructions.draggable
  }), o.createElement(LiveRegion, {
    id: liveRegionId,
    announcement
  }));
...
const DndContext = /* @__PURE__ */ reactExports.memo(function DndContext2(_ref) {
  ...
  return o.createElement(DndMonitorContext.Provider, {
    value: registerMonitorListener
  }, o.createElement(InternalContext.Provider, {
    value: internalContext
  }, o.createElement(PublicContext.Provider, {
    value: publicContext
  }, o.createElement(ActiveDraggableContext.Provider, {
    value: transform
  }, children)), o.createElement(RestoreFocus, {
    disabled: (accessibility == null ? void 0 : accessibility.restoreFocus) === false
  })), o.createElement(Accessibility, {
    ...accessibility,
...
const Context = /* @__PURE__ */ o.createContext({
  activeIndex: -1,
...
function SortableContext(_ref) {
  ...
  return o.createElement(Context.Provider, {
    value: contextValue
  }, children);
}
...
const INPUT_CLASS = "w-full bg-white/10 border border-white/20 rounded-xl px-3 py-2 text-amber-50 placeholder-white/40 backdrop-blur-sm focus:outline-none focus:border-amber-400/60 focus:bg-white/15 transition-all text-sm";
const GLASS_CARD = "bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm";
function SortableLinkRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      className: `rounded-xl border ${isDragging ? "border-amber-400/50 bg-white/15 shadow-lg shadow-amber-900/20" : "border-white/10 bg-white/5"} p-4 mb-3 last:mb-0`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-amber-200/35 font-mono flex-1 truncate", children: draft.isNew ? "new link" : draft.displayText || `link ${idx + 1}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              ...
              onChange: (e) => onUpdate(draft.draftKey, "displayText", e.target.value),
...
function EditPage() {
  ...
  const [avatarPreviewUrl, setAvatarPreviewUrl] = reactExports.useState("");
  ...
  reactExports.useEffect(() => {
    ...
    if (profile) {
      ...
      setAvatarPreviewUrl(((_a = profile.avatarBlob) == null ? void 0 : _a.getDirectURL()) ?? "");
    }
  }, [profile]);
  reactExports.useEffect(() => {
    if (links) {
      setDrafts(
        [...links].sort((a, b) => Number(a.orderIndex) - Number(b.orderIndex)).map((l) => ({
          id: l.id,
          url: l.url,
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "main",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full bg-amber-500/20 border border-amber-400/30 flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link2, { size: 24, className: "text-amber-300" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-amber-100 mb-2", children: "Owner Access Required" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-amber-200/50 text-sm mb-6", children: "Sign in with Internet Identity to edit your profile." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
  ...
  async function handleAvatarChange(e) {
    ...
    try {
      ...
      ue.error("Failed to prepare image");
    } finally {
  ...
  async function handleSaveLink(draft) {
    try {
      if (draft.isNew) {
        await addLink.mutateAsync({
          url: draft.url,
          displayText: draft.displayText,
          icon: draft.icon || void 0,
          orderIndex: BigInt(draft.orderIndex)
        });
        ue.success("Link added!");
      } else if (draft.id !== void 0) {
        ...
        ue.success("Link saved!");
      }
    } catch {
      ue.error("Failed to save link");
    }
  }
  async function handleDeleteLink(draft, idx) {
    if (draft.isNew) {
      setDrafts((prev) => prev.filter((_, i) => i !== idx));
      return;
    }
    if (draft.id === void 0) return;
    try {
      await deleteLink.mutateAsync(draft.id);
      ue.success("Link removed");
    } catch {
      ue.error("Failed to delete link");
    }
  }
  function addNewLink() {
  ...
  function updateDraft(key, field, value) {
    setDrafts(
      (prev) => prev.map((d) => d.draftKey === key ? { ...d, [field]: value } : d)
    );
  }
  async function handleDragEnd(event) {
    ...
    setDrafts(reordered);
    const updates = reordered.filter((d) => !d.isNew && d.id !== void 0);
    await Promise.allSettled(
      updates.map(
        (d) => updateLink.mutateAsync({
          id: d.id,
          url: d.url,
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold text-amber-100", children: "Edit Profile" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "edit.profile_section", className: GLASS_CARD, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-amber-200 mb-5 text-xs uppercase tracking-widest", children: "Profile Info" }),
                profileLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-24 rounded-full bg-white/10 animate-pulse mx-auto" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-10 rounded-xl bg-white/10 animate-pulse" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-20 rounded-xl bg-white/10 animate-pulse" })
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        children: [
                          avatarPreviewUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "img",
                            {
                          ...
                          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full bg-white/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { size: 24, className: "text-amber-200/40" }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-all flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { size: 20, className: "text-white" }) }),
                          avatarUploading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/60 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-white text-xs font-bold", children: [
                            uploadProgress,
                            "%"
                          ] }) })
                        ]
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: avatarUploading && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      motion.div,
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-amber-200/40 text-xs", children: "Click to change photo" })
                  ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "edit.links_section", className: GLASS_CARD, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-amber-200 text-xs uppercase tracking-widest", children: "Links" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
                ...
                linksLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: ["sk-1", "sk-2", "sk-3"].map((id) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                  ...
                  drafts.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-amber-200/35 text-sm", children: "No links yet." }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-amber-200/25 text-xs mt-1", children: 'Click "Add Link" to get started.' })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    DndContext,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        SortableContext,
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { initial: false, children: drafts.map((draft, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                            SortableLinkRow,
                            {
                              draft,
                              idx,
