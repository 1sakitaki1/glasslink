...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, b as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, R as RequestStatusResponseStatus, U as UnknownError, c as RequestStatusDoneNoReplyErrorCode, d as RejectError, e as CertifiedRejectErrorCode, f as UNREACHABLE_ERROR, I as InputError, g as InvalidReadStateRequestErrorCode, h as ReadRequestType, i as Principal, k as IDL, m as MissingCanisterIdErrorCode, H as HttpAgent, n as encode, Q as QueryResponseStatus, p as UncertifiedRejectErrorCode, q as isV3ResponseBody, s as isV2ResponseBody, t as UncertifiedRejectUpdateErrorCode, w as UnexpectedErrorCode, x as decode, S as Subscribable, y as pendingThenable, z as resolveEnabled, A as shallowEqualObjects, B as resolveStaleTime, D as noop$1, F as environmentManager, G as isValidTimeout, J as timeUntilStale, K as timeoutManager, L as focusManager, N as fetchState, O as replaceData, V as notifyManager, W as hashKey, X as getDefaultState, r as reactExports, Y as shouldThrowError, Z as useQueryClient, _ as useInternetIdentity, $ as createActorWithConfig, j as jsxRuntimeExports, a0 as Record, a1 as Opt, a2 as Vec, a3 as Service, a4 as Func, a5 as Nat, a6 as Text, a7 as Nat8, a8 as Bool } from "./index-BKHIuhAu.js";
...
function useAuth() {
  ...
  return {
    ...
    logout: clear,
    loginStatus,
    principalText: (identity == null ? void 0 : identity.getPrincipal().toText()) ?? null
  };
}
...
Service({
  ...
  "addLink": Func(
    [Text, Text, Opt(Text), Nat],
    [LinkId],
    []
  ),
  "deleteLink": Func([LinkId], [], []),
  "getProfile": Func([], [Profile], ["query"]),
  "listLinks": Func([], [Vec(Link)], ["query"]),
  "setProfile": Func([Text, Text, Opt(ExternalBlob$1)], [], []),
  "updateLink": Func(
    [LinkId, Text, Text, Opt(Text), Nat],
    [],
    []
  )
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const Link2 = IDL2.Record({
    "id": LinkId2,
    "url": IDL2.Text,
    "displayText": IDL2.Text,
    "icon": IDL2.Opt(IDL2.Text),
    "orderIndex": IDL2.Nat
  });
  return IDL2.Service({
    ...
    "addLink": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Opt(IDL2.Text), IDL2.Nat],
      [LinkId2],
      []
    ),
    "deleteLink": IDL2.Func([LinkId2], [], []),
    "getProfile": IDL2.Func([], [Profile2], ["query"]),
    "listLinks": IDL2.Func([], [IDL2.Vec(Link2)], ["query"]),
    "setProfile": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Opt(ExternalBlob2)],
      [],
      []
    ),
    "updateLink": IDL2.Func(
      [LinkId2, IDL2.Text, IDL2.Text, IDL2.Opt(IDL2.Text), IDL2.Nat],
      [],
      []
    )
  });
...
class Backend {
  ...
  async addLink(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
        const result = await this.actor.addLink(arg0, arg1, to_candid_opt_n8(this._uploadFile, this._downloadFile, arg2), arg3);
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async getProfile() {
    if (this.processError) {
      try {
        ...
        return from_candid_Profile_n9(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
      }
  ...
  async listLinks() {
    if (this.processError) {
      try {
        const result = await this.actor.listLinks();
  ...
  async setProfile(arg0, arg1, arg2) {
    if (this.processError) {
      try {
        const result = await this.actor.setProfile(arg0, arg1, await to_candid_opt_n17(this._uploadFile, this._downloadFile, arg2));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async updateLink(arg0, arg1, arg2, arg3, arg4) {
    if (this.processError) {
      try {
        const result = await this.actor.updateLink(arg0, arg1, arg2, to_candid_opt_n8(this._uploadFile, this._downloadFile, arg3), arg4);
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
...
async function from_candid_ExternalBlob_n12(_uploadFile, _downloadFile, value) {
  return await _downloadFile(value);
}
function from_candid_Link_n14(_uploadFile, _downloadFile, value) {
  return from_candid_record_n15(_uploadFile, _downloadFile, value);
}
async function from_candid_Profile_n9(_uploadFile, _downloadFile, value) {
...
async function from_candid_record_n10(_uploadFile, _downloadFile, value) {
  return {
    bio: value.bio,
    avatarBlob: record_opt_to_undefined(await from_candid_opt_n11(_uploadFile, _downloadFile, value.avatarBlob)),
    name: value.name
  };
}
...
function from_candid_vec_n13(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_Link_n14(_uploadFile, _downloadFile, x));
}
...
function useProfile() {
  ...
  return useQuery({
    queryKey: ["profile"],
    queryFn: async () => {
      if (!actor) return { name: "", bio: "", avatarBlob: void 0 };
