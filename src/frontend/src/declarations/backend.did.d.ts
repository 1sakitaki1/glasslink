...
export interface _SERVICE {
  ...
  'addLink' : ActorMethod<[string, string, [] | [string], bigint], LinkId>,
  'deleteLink' : ActorMethod<[LinkId], undefined>,
  'getProfile' : ActorMethod<[], Profile>,
  'listLinks' : ActorMethod<[], Array<Link>>,
  'setProfile' : ActorMethod<[string, string, [] | [ExternalBlob]], undefined>,
  'updateLink' : ActorMethod<
    [LinkId, string, string, [] | [string], bigint],
    undefined
  >,
}
