...
import type { ExternalBlob as _ExternalBlob, Link as _Link, LinkId as _LinkId, Profile as _Profile, _ImmutableObjectStorageRefillInformation as __ImmutableObjectStorageRefillInformation, _ImmutableObjectStorageRefillResult as __ImmutableObjectStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addLink(arg0: string, arg1: string, arg2: string | null, arg3: bigint): Promise<LinkId> {
        if (this.processError) {
            try {
    ...
    async deleteLink(arg0: LinkId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async listLinks(): Promise<Array<Link>> {
        if (this.processError) {
            try {
    ...
    async updateLink(arg0: LinkId, arg1: string, arg2: string, arg3: string | null, arg4: bigint): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_Link_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Link): Link {
    return from_candid_record_n15(_uploadFile, _downloadFile, value);
}
async function from_candid_Profile_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Profile): Promise<Profile> {
...
function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Link>): Array<Link> {
